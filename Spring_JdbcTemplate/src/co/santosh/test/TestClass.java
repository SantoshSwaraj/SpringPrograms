...
public class TestClass {
	public static void main(String args[]){
		...
		updatedCourse.setCourseId("framework");
		updatedCourse.setCourseTitle("Spring-Framework 4.3.6");
		updatedCourse.setPrice(17000);
		
		courseDAO.updateCourse("Spring Framework 4.1.2", updatedCourse);
